    ...
    return (
        <>
            <ul className=' w-full lg:w-[424px] py-[38px] px-[25px] rounded-xl shadow-[8px_8px_25px_#F4F4F5] group hover:translate-y-[-4px] duration-200'>
                <li className='p-3 w-fit m-auto rounded-full bg-[#F4F4F5] group-hover:bg-[#7F39B1] duration-200'><span className='text-3xl group-hover:text-white duration-200'>{serviceIcon}</span></li>
